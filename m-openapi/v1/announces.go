...
func (o *openAPI) CreateChannelAnnounces(ctx context.Context, channelID string,
	announce *m_dto.ChannelAnnouncesToCreate) (*m_dto.Announces, error) {
	resp, err := o.request(ctx).
		SetResult(m_dto.Announces{}).
	...
	return resp.Result().(*m_dto.Announces), nil
}
...
func (o *openAPI) CreateGuildAnnounces(ctx context.Context, guildID string,
	announce *m_dto.GuildAnnouncesToCreate) (*m_dto.Announces, error) {
	resp, err := o.request(ctx).
		SetResult(m_dto.Announces{}).
